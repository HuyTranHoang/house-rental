...
✔️Điện 4k,nước 100/ng,xe+wifi+rác free,không phát sinh chi phí.😍ai có nhu cầu vui lòng IB hoặc liên hệ 0838.999988.0975.572.901.',
        2800000, 'Trần Đình Xu, Phường Nguyễn Cư Trinh, Quận 1, TPHCM', 15, 1, 'RESOLVED', 1, 1, 1, 1, 0,
...
TIỀN PHÒNG GIẢM SÂU VÀ KHÔNG TĂNG GIÁ.',
        3200000, '7A/9 Thành Thái, P.14, Quận 10', 20, 1, 'RESOLVED', 1, 1, 10, 1, 0,
        random_date_within_14_days(), now()),
...
Gọi ngay nhé các bạn thân yêu ơi !!!!',
        4800000, 'Nguyễn Thị Thập, Phường Tân Quy, Quận 7, TPHCM', 38, 2, 'RESOLVED', 1, 1, 7, 2, 0,
        random_date_within_14_days(), now());
...
VALUES (1, 1, 1, 5, 'Nhà đẹp giá rẻ !!!!', 0, now(), now());
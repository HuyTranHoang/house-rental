...
VALUES (1, 1, 1, 5, 'Nhà đẹp giá rẻ !!!!', false, random_date_within_14_days(), now()),
       (2, 1, 2, 4, 'Phòng đẹp, giá hợp lý', false, random_date_within_14_days(), now()),
       (3, 1, 3, 5, 'Căn hộ rất đẹp, giá cả hợp lý', false, random_date_within_14_days(), now()),
       (4, 2, 1, 5, 'Có rất nhiều tiện ích xung quanh!', false, random_date_within_14_days(), now()),
       (5, 2, 2, 4, 'Kế bên rạp chiếu phim nha', false, random_date_within_14_days(), now()),
       (6, 2, 3, 5, 'Thuê được nhà giá hời thích quá!!!', false, random_date_within_14_days(), now());
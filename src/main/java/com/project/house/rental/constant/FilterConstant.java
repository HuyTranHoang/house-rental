...
public class FilterConstant {
    ...
    public static final String DELETE_COMMENT_REPORT_FILTER = "deletedCommentReportFilter";
    ...
    public static final String DELETE_ADVERTISEMENT_FILTER = "deletedAdvertisementFilter";
}
